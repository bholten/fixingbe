...
```{r echo=TRUE, message=FALSE, warning=FALSE}
plot.gbm(gbm_model, i.var = "cleverness", n.trees = 500)
```
...
To-Hit is roughly captured by the following formula, $tohit \approx 0.195 + 0.0006458 * cleverness$. Furthermore, there is strong statistical evidence that to-hit is capped after around 500 cleverness and is especially sensitive to rounding.
