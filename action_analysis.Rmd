...
The GBM of Furrycat's data shows a strong relationship between action and both dexterity and intellect.
...
Action is roughly captured by the following formula, $action \approx 45 + 15 * dexterity + 3 * intellect$.
