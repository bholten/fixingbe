...
plot(model.gam.everything, select = 4)
```
```{r echo=FALSE, message=FALSE, warning=FALSE}
plot(model.gam.everything, select = 9)
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
plot(model.gam.everything, select = 13)
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
plot(model.gam.everything, select = 14)
```

```{r echo=FALSE, message=FALSE, warning=FALSE}
plot(model.gam.everything, select = 16)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(armor_df, aes(x = predict(linear.fit.level.armor, newdata = armor_df), y = level, color = "blue")) +
  geom_point() +
