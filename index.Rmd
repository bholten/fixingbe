...
1. The real game logic is probably rounded to human-friendly whole numbers. For example, linear regression may indicate values such as 14.995 -- here we'll round this up to 15, assuming tha it's unlikely that game developers were tuning parameters to that level.
